...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : FREQ_UP_Pin FREQ_DOWN_Pin DUTY_CYCLE_DOWN_Pin DUTY_CYCLE_UP_Pin */
  GPIO_InitStruct.Pin = FREQ_UP_Pin|FREQ_DOWN_Pin|DUTY_CYCLE_DOWN_Pin|DUTY_CYCLE_UP_Pin;
